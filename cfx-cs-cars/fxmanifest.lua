...
data_file 'AUDIO_GAMEDATA'  'audioconfig/kc158k20si_game.dat'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/kc158k20si_sounds.dat'
...
data_file 'AUDIO_GAMEDATA'  'audioconfig/nscb20yg_game.dat'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/nscb20yg_sounds.dat'
data_file 'AUDIO_GAMEDATA'  'audioconfig/rattowc_game.dat'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/rattowc_sounds.dat'
data_file 'AUDIO_GAMEDATA'  'audioconfig/rattruckc_game.dat'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/rattruckc_sounds.dat'
data_file 'AUDIO_GAMEDATA'  'audioconfig/st39e92_game.dat'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/st39e92_sounds.dat'
data_file 'AUDIO_GAMEDATA'  'audioconfig/sunrise_game.dat'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/sunrise_sounds.dat'

-- INSERT MO DITO MGA BAGO
...
data_file 'AUDIO_GAMEDATA' 'audioconfig/nsck24ttotoy_game.dat'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/nsck24ttotoy_sounds.dat'
...
data_file 'AUDIO_GAMEDATA' 'audioconfig/st29b18cfnf_game.dat'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/st29b18cfnf_sounds.dat'
data_file 'AUDIO_GAMEDATA' 'audioconfig/st30ej20_game.dat'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/st30ej20_sounds.dat'
...
data_file 'AUDIO_GAMEDATA' 'audioconfig/aq61subfa20_game.dat'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/aq61subfa20_sounds.dat'
...
data_file 'AUDIO_WAVEPACK'  'sfx/dlc_kc158k20si'
data_file 'AUDIO_WAVEPACK'  'sfx/dlc_lg81hcredeye'
data_file 'AUDIO_WAVEPACK'  'sfx/dlc_lgcy02b16ff'
data_file 'AUDIO_WAVEPACK'  'sfx/dlc_nscb20yg'
data_file 'AUDIO_WAVEPACK'  'sfx/dlc_rattowc'
data_file 'AUDIO_WAVEPACK'  'sfx/dlc_rattruckc'
data_file 'AUDIO_WAVEPACK'  'sfx/dlc_st39e92'
...
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_nsck24ttotoy'
...
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_st29b18cfnf'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_st30ej20'
